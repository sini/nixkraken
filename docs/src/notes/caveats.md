...
Although users can login to their GitKraken account from within the application, **we recommend using the [`gk-login` package](../dev/packages/login.md)** — which comes with NixKraken — **to sign in with GitKraken**.
